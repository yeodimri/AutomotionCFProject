...
public class CrossfitHomePage extends CrossfitAbstractPage {
    ...
    public void shop_CrossfitStuff_ClickOnButton() {
        hoverAndClick(shop, crossfitStuff);
    }

    public void shop_CrossfitStoreClickOnButton() {
    ...
    public void affiliates_how_toClickOnButton() {
    ...
    public void journalInnerFirstLeftClickButton() {
    ...
    public void instagramClickButto() {
