...
public class CrossfitHomePage extends CrossfitAbstractPage {
    ...
    private static final By2 journalMenuLeftButton = new By2("journal first left button", By.xpath("//img[@src='https://assets.crossfit.com/build/img/global/menu/crossfit-journal-black.png']"));
