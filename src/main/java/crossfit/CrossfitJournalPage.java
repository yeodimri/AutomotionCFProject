...
public class CrossfitJournalPage extends CrossfitAbstractPage {
    ...
    private static final By2 journalLogo = new By2("Foudation Button", By.id(("bannerTopOverlayLogo")));
    ...
    public void JournalSearchFieldCheck(String catagory, String language, String TextToSerch) {
        try {
